...
#define STRING_CONFIG_H_AUTHOR "(koroshiya, Sidewinder X1)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  /*
    ...
    */
  /*
  // My own PID autotune @215C° - 27.07.2020
    #define DEFAULT_Kp 13.42
    #define DEFAULT_Ki 1.01
    #define DEFAULT_Kd 44.60
  */

  // My own PID autotune @210C° BMG Wind - 20.09.2020
    #define DEFAULT_Kp 11.84
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // My own PID autotune @60C° - 27.07.2020
  #define DEFAULT_bedKp 43.14
  #define DEFAULT_bedKi 7.64
  #define DEFAULT_bedKd 162.37
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 10000 }   // default: { 2000, 2000, 100, 10000 }
 ...
 */
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves (default: 800)
#define DEFAULT_RETRACT_ACCELERATION  10000    // E acceleration for retracts (default: 10000)
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves (default: 2000)
 ...
 *
 */
//#define Z_MIN_PROBE_PIN P0_10 // P0_10 Probe pin on SKR V1.4T
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 32, -38, -0.275 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 20), (Y_MIN_POS + 20), 50 }
